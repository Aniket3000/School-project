  ...
  return (
    <div className='home'>
      ...
      <div className="school_facilities">
        <h2 style={{fontWeight: "320",textAlign:"center",padding:"50px",color:"black"}}>SCHOOL FACILITIES</h2>
        <div className="general_facilities">
          <div className="image_general_fac">
            <img src="https://img1.wsimg.com/isteam/ip/222b5c40-cbe4-414e-b671-4cae8b60a0b0/4J4A2606%20copy.jpg/:/rs=w:600,h:300,cg:true,m/cr=w:600,h:300" alt="..." />
          </div>
        ...
        <div className="academic_facilities">
          ...
          <div className="image_general_fac">
            <img src="https://img1.wsimg.com/isteam/ip/222b5c40-cbe4-414e-b671-4cae8b60a0b0/pic%2001-0001.jpg/:/rs=w:600,h:300,cg:true,m/cr=w:600,h:300" alt="..." />
          </div>
        </div>
      </div>
      {/* ///////////////////////----------FEATURES--------------/////////////////////////////// */}
      ...
      <div className="feel_school_for_you">
        <div className="feelsch_content">
          <h1 style={{fontFamily:"Quicksand",color:"white",fontSize:"64px",fontWeight:"550",paddingBottom:"25px"}}>Feel like we are the right school for<br />you?</h1>
          <a href="/" style={{textDecoration:"none"}} className='feel_btn'>
            <div className="feel_school_button">
              <i className="bi bi-dash-lg" style={{margin:"0",padding:"0",paddingRight:"5px"}}></i>
              <button>APPLY NOW</button>
              <i className="bi bi-dash-lg" style={{margin:"0",padding:"0",paddingLeft:"5px"}}></i>
            </div>
          </a>
        </div>
      </div>
